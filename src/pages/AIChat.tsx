  ...
  return (
    <div className="min-h-screen flex">
      <motion.aside
        ...
        className="w-80 glass-effect border-r border-gray-200 dark:border-gray-700 flex flex-col"
      >
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              title="Sign Out"
            >
              <LogOut className="h-5 w-5 text-high-contrast" />
            </button>
          </div>
          <p className="text-sm text-high-contrast opacity-70">
          ...
          {conversations.map((conv) => (
            ...
            >
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-high-contrast truncate flex-1">
                  {conv.title}
                </p>
                <button
                  onClick={(e) => {
              ...
              <p className="text-xs text-high-contrast opacity-50 mt-1">
                      ...
                      <div className="mb-2 flex flex-wrap gap-2">
                        {message.attachments.map((att, i) => (
                          ...
                          >
                            ...
                            <span className="text-high-contrast">{att.name}</span>
                          </div>
                        ))}
                      </div>
                    )}
                    <div className="prose prose-sm dark:prose-invert max-w-none text-high-contrast">
            ...
            >
              <div className="flex gap-3">
                ...
                <div className="glass-effect rounded-2xl p-4">
                  <Loader className="h-5 w-5 animate-spin text-high-contrast" />
                </div>
              </div>
            </motion.div>
          )}
        ...
        <div className="p-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="mb-4 flex flex-wrap gap-2">
              {attachments.map((file, index) => (
                ...
                >
                  ...
                  <span className="text-sm text-high-contrast">{file.name}</span>
                  <button
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              title="Attach files"
            >
              <Paperclip className="h-5 w-5 text-high-contrast" />
            </button>
            <input
              type="text"
              value={input}
              ...
              className="flex-1 px-4 py-3 glass-effect rounded-xl text-high-contrast focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
            />
            <button
